...
const AboutBlock = () => {
  return (
    <div className="about-box d-flex flex-wrap bg-glass">
      <div className="about-img">
        <img src="images/about-img.jpg" alt="" />
      </div>
      <div className="about-content-box">
        <div className="acb-inside">
          <h4>Our Story</h4>
          <h5>Welcome to RahiCreations<br />Glad to have you here!<br />We’re keen to tell you about us.</h5>
