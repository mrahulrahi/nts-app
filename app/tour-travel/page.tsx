...
const TourTravelPage = () => {
    const placeCards = [
        { imgUrl: "images/new-york.jpg", title: "New York", body: "One of the most vibrant cities you can visit - a trip no one should miss!" },
        { imgUrl: "images/kuala-lumpur.jpg", title: "Kuala Lumpur", body: "One of the most vibrant cities you can visit - a trip no one should miss!" },
        { imgUrl: "images/hong-kong.jpg", title: "Hong Kong", body: "One of the most vibrant cities you can visit - a trip no one should miss!" },
        { imgUrl: "images/singapore.jpg", title: "Singapore", body: "One of the most vibrant cities you can visit - a trip no one should miss!" },
        { imgUrl: "images/mumbai.jpg", title: "Mumbai", body: "One of the most vibrant cities you can visit - a trip no one should miss!" },
    ]
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="place-card-list d-flex flex-wrap">
                                {placeCards.map((card) => <div className="place-card-item">
                                    <PlaceCard card={card} />
                                </div>)}
                            </div>
                        </div>
